...
function format_and_mount_rootfs_zfs {
...
function setup_chroot_environment {
	...
	USE_ZFS="${USE_ZFS}" chroot /mnt /tmp/chroot-bootstrap.sh
...
function clean_system {
	...
	USE_ZFS="${USE_ZFS}" chroot /mnt /tmp/90-cleanup.sh
